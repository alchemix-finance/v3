...
contract GauntletUSDCFrontierStrategyTest is ERC4626StrategyUnitTestBase {
    function _candidate() internal pure override returns (ERC4626Candidate memory) {
        return ERC4626Candidates.gauntletUSDCFrontier();
    }
...
contract GauntletUSDCFrontierInvariantTest is ERC4626StrategyInvariantTestBase {
    function _candidate() internal pure override returns (ERC4626Candidate memory) {
        return ERC4626Candidates.gauntletUSDCFrontier();
    }
}
